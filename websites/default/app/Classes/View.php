...
class View
{
    ...
    public function Load_Page()
    {
        if (file_exists(VIEW . $this->layout_name . '.html.php')) {
            ...
            explode ('/', $this->layout_name)[0] == 'admin' ? include VIEW . 'admin_header.html.php' : include VIEW . 'header.html.php';                          // Displays website header
            explode('/', $this->layout_name)[0] == 'admin' ? include VIEW . 'admin_layout.html.php' : '';
            explode('/', $this->layout_name)[0] == 'animal' ? include VIEW . 'animal_layout.html.php' : '';
            include VIEW . $this->layout_name . '.html.php';          // Displays unique page content
            explode('/', $this->layout_name) [0] == 'admin' ? include VIEW . 'admin_footer.html.php' : include VIEW . 'footer.html.php';                       // Displays website footer
        }
    }
}